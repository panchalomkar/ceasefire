...
function get_progress_bar($x = 0, $y = 0, $status = 0) {
    switch ($status) {
        case 1: $class = 'course-in-progress';
            break;
        case 1: $class = 'course-completed';
            break;
        case 1: $class = 'course-enrolled';
            break;
        default: $class = '';
            break;
    }
    ...
    $courseenrolled = '<div class="progress-circle ' . $over50 . ' p' . $percentage . '" title="' . $percentage . '%">
